...
describe('validateArgs', () => {
	...
	test('should return TRUE if --config presents in args list ', () => {
	...
	test('should return TRUE if -c presents in args list ', () => {
	...
	test('should return FALSE if -c and --config presents', () => {
	...
	test('should return FALSE if wron arg -test presents in arguments liist', () => {
...
test('should return FALSE if no -c and no --config in arguments', () => {
...
test('should return FALSE if wron arg in arguments', () => {
