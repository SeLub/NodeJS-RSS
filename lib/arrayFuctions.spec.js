...
describe('Function isNextValueExistsInArray ', () => {
	...
	test(`shoud return true`, async () => {
    	...
    	const resault = isNextValueExistsInArray(array, 'test');
	...
	test(`shoud return false`, async () => {
    	...
    	const resault = isNextValueExistsInArray(array, 'testNoexist');
	...
	test(`shoud return 1`, async () => {
    	...
    	const resault = isNextValueExistsInArray(array, 'c2');
